...
import 'package:harrasi_rope_factory/features/customers/views/widgets/edit_customer_modal_bottom_sheet_body.dart';
    ...
    return GestureDetector(
      ...
      child: ListTile(
        ...
        trailing: DeleteAndEditMenuButton(
          ...
          onDeleteTap: () {
            context.read<CustomersCubit>().deleteCustomer(id: customerModel.id);
          },
          onEditTap: () {
            showModalBottomSheet(
              context: context,
              ...
              builder: (context) {
                return BlocProvider(
                  create: (context) =>
                      EditCustomerCubit(customer: customerModel),
                  child: EditCustomerModalBottomSheetBody(
                      customerModel: customerModel),
                );
              },
            );
